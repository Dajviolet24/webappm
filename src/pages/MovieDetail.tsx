...
import { ChevronLeft, Star, Calendar, Clock, Play, Info } from 'lucide-react';
...
const MovieDetail = () => {
  ...
  }, [selectedSeason, isSeriesContent, formattedEpisodes.length, episodeIdFromUrl]);
  ...
  const currentVideoUrl = isSeriesContent && selectedEpisode 
  ...
  const currentTitle = isSeriesContent && selectedEpisode 
            ...
            try {
              ...
              if (iframeDoc) {
                const adSelectors = [
                  ...
                  'iframe[src*="ads"]', 'iframe[src*="adsystem"]', '[id*="adsense"]',
                  '.advertisement', '.ads', '.ad-container', '.popup-ad',
                  '[class*="modal"]', '[id*="modal"]', '.interstitial'
                ];
  ...
  if (movieError || !movie) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 bg-gradient-to-br from-gray-900 via-black to-gray-800">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">Película no encontrada</h2>
        <p className="text-white/60 mb-4 text-center text-sm sm:text-base">El contenido que buscas no existe o ha sido eliminado.</p>
        <button 
          onClick={() => navigate('/')}
          className="px-4 py-2 bg-movieBlue text-white rounded-lg hover:bg-movieBlue/80 text-sm sm:text-base transition-colors"
        >
          Volver al Inicio
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col min-h-screen pb-16 sm:pb-20 bg-gradient-to-br from-gray-900 via-black to-gray-800">
      {/* Header */}
      <div className="relative">
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-black/95 via-gray-900/95 to-gray-800/95 backdrop-blur-lg border-t border-white/10">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Title */}
            <h1 className="text-xl sm:text-3xl lg:text-5xl font-bold mb-4 text-white leading-tight bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent drop-shadow-lg">{currentTitle}</h1>
            ...
            {/* Synopsis */}
            <div className="mb-6">
              <h3 className="text-lg sm:text-xl font-semibold mb-3 text-white flex items-center">
                <Info className="w-5 h-5 mr-2 text-movieBlue" />
                Sinopsis
              </h3>
              <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg p-4 sm:p-6 rounded-xl border border-white/10 shadow-xl">
                <p className="text-sm sm:text-base text-white/90 leading-relaxed">
                  {selectedEpisode?.synopsis || movie.synopsis || "Una historia emocionante que te mantendrá entretenido de principio a fin."}
                </p>
              </div>
            </div>
            ...
            {/* Series Details */}
            {isSeriesContent && (
              <div className="mb-6 bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg p-4 sm:p-6 rounded-xl border border-white/10 shadow-xl">
                <h3 className="text-lg sm:text-xl font-semibold mb-4 text-white flex items-center">
                  <Info className="w-5 h-5 mr-2 text-movieBlue" />
